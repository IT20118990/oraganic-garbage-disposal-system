    ...
    <Navbar>
      <Nav navbar>
        <NavItem>
          ...
          <NavLink className="nav-link" to="/home">
            <i class="fa fa-check-circle-o" aria-hidden="true"></i> Agricultural sector
          </NavLink>
          <NavLink className="nav-link" to="/home">
                <i class="fa fa-trophy" aria-hidden="true"></i> Drivers
              </NavLink>
          <NavLink className="nav-link" to="/home">
          ...
          <NavLink className="nav-link" to="/home">
            <i class="fa fa-bell" aria-hidden="true"></i> Feedback
          </NavLink>
        </NavItem>
      </Nav>
    </Navbar>
