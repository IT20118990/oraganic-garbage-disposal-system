      ...
      <div className="container">
        <div className="row justify-content-center">
          ...
          <div className="col-7 col-sm-4 text-center">
            <h5>Our Address</h5>
            <address>
              Organic Waste Collection Company,
              125, HighLevel Road
              <br />
              Colombo
              <br />
              Sri Lanka
              <br />
              <i className="fa fa-phone fa-lg"></i>: 011 265 4569
              <br />
              <i className="fa fa-fax fa-lg"></i>: 021 865 4562
              <br />
              <i className="fa fa-envelope fa-lg"></i>:{" "}
              <a href="mailto:info@mmv.lk">info@techno.lk</a>
            </address>
          </div>
        ...
        <div className="row justify-content-center">
          <div className="col-auto">
            <br></br>
            <p>
              Copyright 2023 © Organic Waste Connection (Pvt)Ltd. All Rights Reserved.
            </p>
          </div>
        </div>
      </div>
