...
class UpdateFormCustomer extends Component {
    ...
    constructor(props) {
      ...
      onSubmit(e) {
        ...
        axios.put('http://localhost:5000/backend/CustomerR/' + this.props.name, exercise)
          .then(res => {
                ...
                <div className="container mt-3 text-start">
                    ...
                    <div className="row my-1">
                        <div className="col col-2">
                            <label htmlFor="ServiceID"> Customer ID </label>
                        </div>
                        <div className="col col-3">
                            <input className="form-control" id="ServiceID"
                            type='text' 
                            value={this.state.ServiceID}
                            onChange={this.onChangeServiceID} disabled />
                        </div>
                    </div>
                    <div className="row my-1">
                        <div className="col col-2">
                            <label htmlForor="name"> Customer Name </label>
                        </div>
                        <div className="col col-3">
